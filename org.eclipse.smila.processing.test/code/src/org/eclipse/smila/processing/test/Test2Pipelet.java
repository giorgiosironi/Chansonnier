 ...
 *
 */
public class Test2Pipelet implements SimplePipelet, SearchPipelet {
  /**
   * local logger.
   */
  ...
  public void configure(final PipeletConfiguration configuration) throws ProcessingException {
    _log.info("Test2Pipelet.configure():");
  }
  ...
  public Id[] process(final Blackboard blackboard, final Id[] recordIds) throws ProcessingException {
    _log.info("Test2Pipelet.process():");
    return recordIds;
  }
  ...
  public SearchMessage process(final Blackboard blackboard, final SearchMessage message)
    ...
    _log.info("Test2Pipelet.process(search):");
    return message;
  }
}
