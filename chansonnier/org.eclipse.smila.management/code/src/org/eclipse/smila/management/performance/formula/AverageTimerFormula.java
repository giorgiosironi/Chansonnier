...
/**
 * The Class AverageTimerFormula.
 */
public class AverageTimerFormula implements PerformanceCounterFormula {
  ...
  public double calculateValue(final PerformanceSample sample1, final PerformanceSample sample2) {
    final double numerator = sample2.getTimestamp() - sample1.getTimestamp();
