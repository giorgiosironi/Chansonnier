 ...
 * 
 * Contributors: Ivan Churkin (brox IT Solutions GmbH) - initial creator, based on Alexander Eliseyev (brox IT Solutions
 * GmbH) work
 **********************************************************************************************************************/
 ...
 */
public class SimpleCountFormula implements PerformanceCounterFormula {
  /**
   * {@inheritDoc}
   */
  public double calculateValue(final PerformanceSample sample1, final PerformanceSample sample2) {
    return sample2.getRawValue();
  }
}
