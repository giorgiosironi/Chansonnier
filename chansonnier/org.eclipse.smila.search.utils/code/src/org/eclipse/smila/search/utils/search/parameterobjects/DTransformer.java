 ...
 */
public class DTransformer implements Cloneable {
  ...
  public Object clone() {
    DTransformer t;
    try {
      t = (DTransformer) super.clone();
    } catch (final CloneNotSupportedException e) {
      throw new RuntimeException("Cannot clone DTransformer", e);
    }

    if (_parameterSet != null) {
      t.setParameterSet((DParameterSet) _parameterSet.clone());
    }
    return t;
  }
