      ...
      <form name="searchform" action="/SMILA/search" accept-charset="UTF-8" method="post">
        <table>
          ...
          <tr>
            <td>Content:</td>
            <td>
              <input type="text" name="A.Content" value="{r:Record/r:A[@n='Content']/r:L}" />
              <!--  overwrite TextField parameters from data dictionary //-->         
              <input type="hidden" name="R.Operator.Content" value="OR" />
			  <input type="hidden" name="R.Tolerance.Content" value="tolerant" />   
            ...
            <td>Title:</td>
            <td>
              <input type="text" name="A.Title" value="{r:Record/r:A[@n='Title']/r:L}" />
            </td>
		  </tr>
 		  <tr>            
 			<td>Path:</td>
            <td>
              <input type="text" name="A.Path" value="{r:Record/r:A[@n='Path']/r:L}" />
            </td>  
 			<td>Filename:</td>
            <td>
              <input type="text" name="A.Filename" value="{r:Record/r:A[@n='Filename']/r:L}" />
            </td>                      
          </tr>          
         <tr>            
 			<td>MimeType:</td>
            <td>
              <input type="text" name="A.MimeType" value="{r:Record/r:A[@n='MimeType']/r:L}" />
            </td>  
 			<td>Extension:</td>
            <td>
              <input type="text" name="A.Extension" value="{r:Record/r:A[@n='Extension']/r:L}" />
            </td>                      
          </tr>		  
		  <tr>
          	<td colspan="4">
		  ...
		  <tr>            
            <xsl:variable name="dateRangeFilter" select="r:Record/r:A[@n='LastModifiedDate']/r:An[@n='filter']" />       
 			<td>LastModifiedDate (min):</td>
            <td>
              <input type="text" name="Fmin.LastModifiedDate" value="{$dateRangeFilter/r:V[@n='min']}" />
            </td>
 			<td>LastModifiedDate (max):</td>
            <td>
              <input type="text" name="Fmax.LastModifiedDate" value="{$dateRangeFilter/r:V[@n='max']}" />
            </td>                      
          </tr>
		  <tr>                   
		  	<xsl:variable name="sizeRangeFilter" select="r:Record/r:A[@n='Size']/r:An[@n='filter']" />       
 			<td>FileSize (min):</td>
            <td>
              <input type="text" name="Fmin.Size" value="{$sizeRangeFilter/r:V[@n='min']}" />
            </td>
 			<td>FileSize (max):</td>
            <td>
              <input type="text" name="Fmax.Size" value="{$sizeRangeFilter/r:V[@n='max']}" />
            </td>                                  
          </tr>        
          <tr>
          	<td colspan="4">
