 ...
 * @author mcimpean
 */
public class TestConcurrentBSSAccess extends DeclarativeServiceTestCase {
...
class BSSReadWriter extends Thread {
  ...
  private void executeNonRandomCalls() throws BinaryStorageException, IOException {
    for (int i = 0; i < TestConcurrentBSSAccess.ACCESS_NUMBER_PER_THREAD; i++) {
   ...
   *           Signals that an I/O exception has occurred.
   */
  private void callBSS(final String currentId, final String initFileContent) throws BinaryStorageException, IOException {
