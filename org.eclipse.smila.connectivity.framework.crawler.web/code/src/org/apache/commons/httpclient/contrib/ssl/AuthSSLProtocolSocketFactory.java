 ...
 * 
 * This File is based on the AuthSSLProtocolSocketFactory.java (Contrib) from commons-httpclient-3.0.1-src
 ...
 * <pre>
 * Protocol authhttps =
 *   new Protocol(&quot;https&quot;, new AuthSSLProtocolSocketFactory(new URL(&quot;file:my.keystore&quot;), &quot;mypassword&quot;, new URL(
...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
   ...
   *          Password to unlock the keystore. IMPORTANT: this implementation assumes that the same password is used to
