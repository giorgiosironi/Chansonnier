...
/**
 * Test suite for org.eclipse.smila.connectivity.framework.agent.jobfile bundle.
 */
public final class AllTests {
  ...
  public static Test suite() {
    ...
    final TestSuite suite = new TestSuite("Tests for org.eclipse.smila.connectivity.framework.agent.jobfile");
    // $JUnit-BEGIN$
    suite.addTestSuite(TestConfigLoad.class);
    suite.addTestSuite(TestConfigMarshall.class);
    suite.addTestSuite(TestJobFileReader.class);
