 ...
 */
public class TestConcurrentBSSAccessJPA extends DeclarativeServiceTestCase {
  ...
  /** The logger. */
  private final Log _log = org.apache.commons.logging.LogFactory.getLog(TestConcurrentBSSAccessJPA.class);
...
class BSSReadWriter extends Thread {
  ...
  private void executeNonRandomCalls() throws BinaryStorageException, IOException {
    for (int i = 0; i < TestConcurrentBSSAccessJPA.ACCESS_NUMBER_PER_THREAD; i++) {
