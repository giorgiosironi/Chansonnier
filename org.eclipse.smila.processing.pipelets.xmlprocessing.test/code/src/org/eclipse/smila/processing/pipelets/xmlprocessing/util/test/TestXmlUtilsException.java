...
/**
 * Test class for XmlUtilsException.
 */
public class TestXmlUtilsException extends TestCase {
  ...
  public void testExceptions() {
    ...
    XMLUtilsException xsle = new XMLUtilsException();
    assertNotNull(xsle);
    assertNull(xsle.getCause());

    xsle = new XMLUtilsException(msg);
    assertNotNull(xsle);
    assertEquals(msg, xsle.getMessage());
    assertNull(xsle.getCause());

    xsle = new XMLUtilsException(cause);
    assertNotNull(xsle);
    ...
    xsle = new XMLUtilsException(msg, cause);
    assertNotNull(xsle);
    assertEquals(msg, xsle.getMessage());
    assertNotNull(xsle.getCause());
    assertEquals(cause, xsle.getCause());
