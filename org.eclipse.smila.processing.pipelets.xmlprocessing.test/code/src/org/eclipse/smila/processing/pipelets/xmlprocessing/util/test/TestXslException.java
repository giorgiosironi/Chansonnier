...
/**
 * Test class for TestXslException.
 */
public class TestXslException extends TestCase {
  ...
  public void testExceptions() {
    ...
    XslException xsle = new XslException();
    assertNotNull(xsle);
    assertNull(xsle.getCause());

    xsle = new XslException(msg);
    assertNotNull(xsle);
    assertEquals(msg, xsle.getMessage());
    assertNull(xsle.getCause());

    xsle = new XslException(cause);
    assertNotNull(xsle);
    ...
    xsle = new XslException(msg, cause);
    assertNotNull(xsle);
    assertEquals(msg, xsle.getMessage());
    assertNotNull(xsle.getCause());
    assertEquals(cause, xsle.getCause());
